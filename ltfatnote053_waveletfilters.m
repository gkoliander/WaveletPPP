function [gout,info] = ltfatnote053_waveletfilters(L,scales,varargin)
...
[gout,info] = ltfatnote053_freqwavelet(winCell,L,scales,'asfreqfilter','efsuppthr',kv.trunc_at,'basefc',0.1);
